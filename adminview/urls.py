...
from adminview.views import show_admin, edit_product, delete_product, show_xml, show_json, show_xml_by_id, show_json_by_id, create_product_ajax, show_json_random, create_product_flutter, update_flutter
